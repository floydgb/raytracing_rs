...
fn main() {
        ...
        for b in -11..=11 {
            ...
            if (center - Vec3::new(4.0, 0.2, 0.0)).length() > 0.9 {
                if choose_mat < 0.8 {
                    ...
                    world.add(Box::new(Sphere::new(center, random_radius(), sphere_material)));
    ...
    world.add(Box::new(Sphere::new(Vec3::new(0.0, 1.0, 0.0), random_radius(), material1)));
    world.add(Box::new(Sphere::new(Vec3::new(-4.0, 1.0, 0.0), random_radius(), material2)));
    world.add(Box::new(Sphere::new(Vec3::new(4.0, 1.0, 0.0), random_radius(), material3)));
